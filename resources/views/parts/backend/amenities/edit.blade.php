                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" id="myform" action="{{route('admin.amenities.edit',['id'=>$amenity->id])}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Tên tiện ích</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control  {{$errors->has('names') ?'is-invalid':''}}" placeholder="Tên tiện ích"  name="names" value="{{$amenity->names?$amenity->names:old('name')}}">
                                            @error('name')
