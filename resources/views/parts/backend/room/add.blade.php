                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                ...
                                                <input type="file" name="image"
                                                       class="form-control-file {{$errors->has('image') ?'is-invalid':''}}" id="cmt_truoc" value="1 {{old('image')}}" >
                                                @error('image')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row" id="image-preview-container">
                                            <!-- Image preview will be added dynamically here -->
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6">
                                                
                                                <input type="file" name="images[]" class="form-control-file image-input" value="0" multiple>
