                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-titles"></h4>
                                             ...
                                             <div class="lg-3-row"><a href="{{route('admin.roomType.getform')}}">
                                                <button type="button" class="btn btn-primary mb-2 btn-add">Thêm loại phòng</button>
                                                     </a>
                                                     <a href="{{route('admin.roomType.trashed')}}">
