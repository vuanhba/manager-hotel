                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" id="myform" action="{{route('admin.users.edit',['id'=>$data->id])}}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Tên khách hàng</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control  {{$errors->has('name') ?'is-invalid':''}}" placeholder="Tên khách hàng"  name="name" value="{{$data->name ?? old('name')}}">
                                        @error('name')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control  {{$errors->has('email') ?'is-invalid':''}}" placeholder="Email"  name="email" value="{{$data->email ?? old('email')}}">
                                        @error('email')
                                        <div class="invalid-feedback">
                                        {{$message}}
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control  {{$errors->has('password') ?'is-invalid':''}}" placeholder="password"  name="password" value="{{$data->password ?? old('password')}}">
                                        @error('password')
                                        <div class="invalid-feedback">
                                        {{$message}}
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min=0 class="form-control  {{$errors->has('phone') ?'is-invalid':''}}" placeholder="phone"  name="phone" value="{{$data->phone ?? old('phone')}}">
                                        @error('phone')
                                        <div class="invalid-feedback">
                                        {{$message}}
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <select class="default-select form-control wide {{$errors->has('status') ?'is-invalid':''}}" name="status" id="inlineFormCustomSelect">
                                        ...
                                        <option value="1" {{ old('status')||$data->status == '1' ? 'selected' : '' }}>Hoạt động</option>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                     ...
                                                     @if ($data->image_url)
                                                   <img id="cmt_truoc" src="{{Storage::url($data->image_url)}}" alt="your image"
